...
class Config(object):
    def __init__(self, config):
        ...
        self.tokens_file = config["REPORT PROPERTIES"]["TOKENS"]
        self.word_count_file = config["REPORT PROPERTIES"]["WORD_COUNT"]
        self.subdomains_file = config["REPORT PROPERTIES"]["SUBDOMAINS"]
